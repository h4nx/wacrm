...
//
// Why the `convix_live_` prefix
//   - Self-identifying: a leaked string is instantly recognisable as
//     a convix key (handy for secret-scanners like GitGuardian).
//   - Forward-compatible: leaves room for a `convix_test_` variant if
...
export const API_KEY_PREFIX = 'convix_live_';
