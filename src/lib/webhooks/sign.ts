...
//
// Every delivery carries an `X-Convix-Signature` header so receivers
// can verify the request really came from convix and wasn't tampered
// with or replayed. The scheme is Stripe-style:
//
//   X-Convix-Signature: t=<unix_seconds>,v1=<hex HMAC-SHA256>
//
...
/**
 * Build the `X-Convix-Signature` header value for `rawBody`, signed
...
/**
 * Verify a signature header. Exposed so a convix-to-convix integration
