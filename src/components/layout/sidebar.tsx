    ...
    <>
      ...
      <aside
        className={cn(
          ...
          "fixed inset-y-0 left-0 z-40 flex h-full w-[260px] flex-col border-r border-sidebar-border bg-sidebar",
          "transition-transform duration-200 ease-out will-change-transform",
          open ? "translate-x-0" : "-translate-x-full",
          // Desktop: static, always visible — reset all the mobile framing.
          "lg:static lg:z-0 lg:w-[260px] lg:translate-x-0 lg:transition-none",
        )}
        aria-label="Primary"
      >
        ...
        <div className="flex h-14 shrink-0 items-center justify-between gap-2 border-b border-sidebar-border px-4">
          <Link href="/dashboard" className="flex items-center gap-2">
            <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-primary text-primary-foreground">
              <ConvixLogo className="h-6 w-6" />
            </div>
            <span className="text-sm font-semibold text-sidebar-foreground">Convix</span>
          </Link>
          <button
            type="button"
            onClick={onClose}
