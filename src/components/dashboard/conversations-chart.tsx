...
// Formats dates in the app's configured locale (not the visitor's
// browser locale) so month/weekday names stay consistent regardless
// of who's viewing — see src/i18n/request.ts for the same source.
